defmodule Identicons do
  ...
  def draw_image(%Identicons.Image{colors: color, pixel_map: pixel_map}) do
  ...
  def filter_odd_squares(%Identicons.Image{grid: grid} = image) do
  ...
  def pick_color(%Identicons.Image{hex: [r,g,b | _tail]} = image) do
    %Identicons.Image{ image | colors: {r, g, b} }
  end
end
